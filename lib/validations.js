...
// ===== SUBSCRIPTION SCHEMA =====
// Used for both paths into a subscription: a detected candidate the user
// confirms, and one they type in themselves. Detection output is not trusted
// any more than a form is — it still comes through the client.
export const subscriptionSchema = z.object({
  ...
  frequency: z.enum(["monthly", "yearly"], {
    message: "Frequency must be monthly or yearly",
  }),
  nextDueDate: dateOnly,
});

// Note: schemas for goals and 80C entries arrive in phase 7.
