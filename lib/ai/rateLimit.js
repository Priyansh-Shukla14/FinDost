...
// Tunable without a code change: set AI_DAILY_LIMIT_FREE / AI_DAILY_LIMIT_PRO
// in the environment. These are a cost guard on our side — Gemini's own
// per-day quota still applies on top of whatever is set here.
...
export const DAILY_LIMITS = {
  free: limitFromEnv("AI_DAILY_LIMIT_FREE", 100),
  pro: limitFromEnv("AI_DAILY_LIMIT_PRO", 500),
};
